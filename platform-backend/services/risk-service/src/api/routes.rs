...
async fn assess_risk(
    ...
    let cmd = AssessPaymentRiskCommand {
        ...
        // In production these come from the JWT principal extracted by middleware.
        // For now, read from a header or default to platform_admin for backward compat.
        principal_role: "platform_admin".into(),
        principal_operator_id: req.operator_id,
    };
