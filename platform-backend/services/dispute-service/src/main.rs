...
async fn main() {
    ...
    let service = DisputeServiceImpl::new(Box::new(repo), db.clone());
    ...
    let shutdown = platform_middleware::shutdown_signal(platform_middleware::ShutdownConfig::standard("dispute-service"));
