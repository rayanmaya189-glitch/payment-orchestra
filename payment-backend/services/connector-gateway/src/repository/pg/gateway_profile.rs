...
fn domain_to_model(profile: &GatewayProfile) -> Result<GatewayProfileModel, String> {
...
fn model_to_domain(m: GatewayProfileModel) -> Result<GatewayProfile, String> {
    ...
    fn test_domain_model_roundtrip() {
        ...
        let profile = GatewayProfile {
            ...
            limits: TransactionLimits {
                ...
                daily_volume_limit_minor: 50000000,
                monthly_volume_limit_minor: 1000000000,
                max_refund_amount_minor: 1000000,
            },
            fees: FeeStructure {
                fixed_fee_minor: 100,
