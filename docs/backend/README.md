...
- **REST paths + protobuf bodies**: RESTful URL paths (POST/PATCH/DELETE) with protobuf-encoded request/response bodies and NATS event payloads. Internal gRPC for service-to-service. No GET, no JSON, no form data.
